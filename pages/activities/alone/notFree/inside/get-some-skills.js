  ...
  <div className={styles.activityContainer}>
    <p>
      <span>
        ...
        {' '}
        But I&apos;ve thought about that concept often since then, usually at night when I&apos;m on hour three of mindless TV watching.
      </span>
    </p>
    <p>
      It&apos;s obviously infinitely easier to be a consumer
      but, perhaps less obviously, infinitely more rewarding to be a creator.
      And if you read that and thought &quot;Oh, but I&apos;m not the creative type&quot;:
    ...
    <p>You&apos;ve got this. Your journey to creation starts tonight.</p>
    <p>
      <span>
        And if you already have some skills you want to share,
        {' '}
        <LinkTo
